...
window.onload = function() {
	...
	$('#enchant-stage').css({
		"position":"absolute","left":left+"px","top":(top+100)+"px",
	});
	...
	game.onload = function() {
		...
		var jumpTheme = {
			normal : {
				color : '#FFF',
				background: { type: 'linear-gradient', start: '#988aff', end: '#988aff ' },
				border: { color: '#66d0ff', width: 1, type: 'solid' },
			...
			active : {
				...
				background: { type: 'linear-gradient', start: '#FFF', end: '#FFF' },
				border: { color: '#ff66b8', width: 1, type: 'solid' },
				textShadow: { offsetX: 0.5, offsetY: 0.5, blur: '3px', color: '#F00' },
				boxShadow: { offsetX: 2, offsetY: 2, blur: '5px', color: 'rgba(0, 0, 0, 0.3)' }
			}
		}
